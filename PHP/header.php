...
<body>
    ...
    <nav>
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="avg.php">Sacar Promedio Total de Pasajeros con uso de AVG</a></li>
            <li><a class="dropdown-item" href="fun.php">Uso de Funciones</a></li>
            <li><a class="dropdown-item" href="join3.php">Uso de Joins</a></li>
            <li><a class="dropdown-item" href="cube.php">Uso Cube , ROLLUP</a></li>
            <li><a class="dropdown-item" href="Prod.php">Procedimiento 1</a></li>
            <li><a class="dropdown-item" href="Prod2.php">Procedimiento 2</a></li>
            <li><a class="dropdown-item" href="union.php">Uso de Union</a></li>
            <li><a class="dropdown-item" href="grupo.php">Uso de Group By</a></li>
        </ul>
        </div>
